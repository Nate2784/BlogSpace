...
AUTHENTICATION_BACKENDS = [
    'blog.auth_backends.EmailOrUsernameBackend',  # Custom backend for email/username login
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='BlogSpace <noreply@blogspace.com>')
